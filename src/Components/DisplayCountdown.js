...
function DisplayCountdown() {
    return (
        <div className="countdown-container">
            <MyAudio/>
            <Clock target = {"09 November 2023 12:00 Am"} title={"Richard's Birthday in..."}/>
            <Clock target = {"24 December 2023 12:00 Am"} title={"Roysten's Birthday in..."}/>
            <Clock target = {"25 December 2023 12:00 Am"} title={"Christmas Countdown..."}/>
